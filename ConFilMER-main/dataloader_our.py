...
class IEMOCAPDataset(Dataset):
    ...
    def __init__(self, train=True):
        ...
        self.speakers, self.labels, self.roberta1, self.roberta2, self.roberta3, self.roberta4,\
        self.sentences, self.trainIds, self.testIds, self.validIds = pickle.load(open('./IEMOCAP_features/iemocap_features_roberta.pkl', 'rb'), encoding='latin1')
        '''
...
class MELDDataset(Dataset):
    ...
    def __init__(self, path, train=True):
        ...
        self.speakers, self.emotion_labels, self.sentiment_labels, self.roberta1, self.roberta2, self.roberta3, self.roberta4, \
